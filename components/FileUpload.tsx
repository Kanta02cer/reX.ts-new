    ...
    <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
      ...
      >
        <div className="space-y-4">
          ...
          <div>
            <p className="text-lg font-medium text-gray-900">CSVファイルをドラッグ&ドロップ</p>
            <p className="text-sm text-gray-500">または、ボタンをクリックしてファイルを選択</p>
          </div>
      ...
      {error && (
        <div className="mt-4 rounded-md bg-red-50 p-4">
          <div className="flex">
            ...
            <div className="ml-3">
              <h3 className="text-sm font-medium text-red-800">ファイル処理エラー</h3>
